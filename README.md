...
Redémarrer Claude Desktop pour activer les 73 outils
`mcp__connaissance__*`.
...
73 outils mappés 1:1 vers les sous-commandes CLI :
...
Total : **73 outils** sur **19 groupes**.
...
Les 73 outils MCP ne contiennent aucune logique métier : ils mappent
