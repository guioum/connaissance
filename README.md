...
Redémarrer Claude Desktop pour activer les 57 outils
`mcp__connaissance__*`.
...
57 outils mappés 1:1 vers les sous-commandes CLI :
...
Total : **57 outils** sur **14 groupes**.
...
Les 57 outils MCP ne contiennent aucune logique métier : ils mappent
