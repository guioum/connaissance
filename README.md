...
Redémarrer Claude Desktop pour activer les 50 outils
`mcp__connaissance__*`.
...
50 outils mappés 1:1 vers les sous-commandes CLI :
...
Total : **50 outils** sur **13 groupes**.
...
Les 50 outils MCP ne contiennent aucune logique métier : ils mappent
