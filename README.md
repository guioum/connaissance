...
Redémarrer Claude Desktop pour activer les 59 outils
`mcp__connaissance__*`.
...
59 outils mappés 1:1 vers les sous-commandes CLI :
...
Total : **59 outils** sur **15 groupes**.
...
Les 59 outils MCP ne contiennent aucune logique métier : ils mappent
