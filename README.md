...
Redémarrer Claude Desktop pour activer les 58 outils
`mcp__connaissance__*`.
...
58 outils mappés 1:1 vers les sous-commandes CLI :
...
Total : **58 outils** sur **15 groupes**.
...
Les 58 outils MCP ne contiennent aucune logique métier : ils mappent
